...
class Carafe(object):
    ...
    def add_time(self, seconds, comment):
        ...
        :param seconds: Number of added seconds to add to elapsed time
        ...
        """
        event = CleaningEvent(seconds, f'{comment} for {seconds} seconds')
    ...
    def play_back_events(self, realtime):
        ...
        for event in self.events:
            ...
            if realtime:
                sleep(event.seconds)
        print(f'Total time: {self.seconds_elapsed} seconds')
    ...
    def pour_out(self, extra_drip):
        ...
        self.add_time(seconds_to_pour, f'Pouring {self.contents_ml} ml ')
    ...
    def fill(self, fill_amt_ml):
        ...
        self.add_time(fill_amt_ml / FILL_ML_PER_SECOND, 'Filling')
